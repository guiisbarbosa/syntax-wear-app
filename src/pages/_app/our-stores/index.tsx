  ...
  return (
    <section className="container py-6">
      <img
        ...
        className="rounded-[20px] h-80 m:h-125 object-cover w-full"
      />

      <div>
        <h1 className="text-black text-2xl max-w-7xl m-auto my-20 text-center">
          Nossas lojas são o coração da nossa marca. Explore a coleão mais
        ...
        <section className="text-black w-full space-y-20">
          ...
          <div className="flex flex-col md:flex-row items-center gap-2.5">
            ...
            <div className="text-center py-6 px-3">
              ...
              <p>
                Conte com dicas de estilo, sugestões exclusivar e suporte personalizado de quem realmente entende de moda.
              </p>
            </div>
          </div>
        </section>
