  ...
  return (
    <form className="text-black">
      ...
      <button
        ...
        className="bg-accent text-white font-semibold uppercase rounded-md py-3 transition-all hover:bg-accent-hover disabled:opacity-50 disabled:cursor-wait w-full cursor-pointer mt-5"
      >
